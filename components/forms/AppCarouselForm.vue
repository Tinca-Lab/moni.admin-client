...
export default {
  ...
  components: { AppButton,AppIconConfig,AppInput,AppIconTrash,AppIconEdit  },
  props: {
    value: {
      type: Object,
      default: () => ({})
  ...
  methods: {
    ...
    editImage(e){
      // const id = e.target.id.substring(5);
      // const imgUrl = this.dataImage[id].images.preview;
      ...
      for (const element of files) {
        ...
        reader.onload = (e) => {
          ...
          this.dataImage[this.id].images = image;
    ...
    deleteImage(){
      this.dataImage.splice(this.id, 1);
      this.updateDataImage();
      this.editing = !this.editing;
    },
    ...
    onLoadPictures(e) {
      ...
      for (const element of files) {
        ...
        reader.onload = (e) => {
          ...
          this.dataImage[this.dataImage.length-1].descrption = 'click to the setting for modify this text';
          this.dataImage[this.dataImage.length-1].titleCta = 'example';
          this.dataImage[this.dataImage.length-1].positionX = 'left';
          this.dataImage[this.dataImage.length-1].positionY = 'bottom';
